...
void show_help (void)
{
  ...
  printf(
    ...
    "\n"
    "   no_split_file (default is split file)\n"
    "      This option control S3 upload download object not use split file.\n"
    "      split file because kingsoft S3 implement poor performance file size \n"
    "      large than 5 GB.\n"
    "      Un set this option better performance\n"
    "\n"
    "   split_file_size (default=\"4096\")\n"
    "      - split file size, in MB, for control S3 upload download object\n"
    "      use split file size.\n"
    "      maximum size 5120(5GB)\n"
    "\n"
    "   read_use_split_file_size (default is use split file size)\n"
    "      This option set fuse fuction <read> implement get file size \n"
    "      by s3 or default split_file_size value.\n"
